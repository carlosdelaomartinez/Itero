...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ \"./src/game.js\");\n/* harmony import */ var _ground__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ground */ \"./src/ground.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Level =\n/*#__PURE__*/\nfunction () {\n  function Level() {\n    _classCallCheck(this, Level);\n  }\n\n  _createClass(Level, [{\n    key: \"pushRoads\",\n    value: function pushRoads(minLengthRequirement, height, optLength) {\n      this.paths = this.generateLengthPojos(minLengthRequirement);\n      this.generateRoads(this.paths[0], this.paths[1], this.paths[2], minLengthRequirement, height, optLength);\n    }\n  }, {\n    key: \"generateRoads\",\n    value: function generateRoads(fgToRender, mgToRender, bgToRender, minLengthRequirement, height, optLength) {\n      this.genRoad(_ground__WEBPACK_IMPORTED_MODULE_1__[\"Background\"], bgToRender, minLengthRequirement, height, optLength, false);\n      this.genRoad(_ground__WEBPACK_IMPORTED_MODULE_1__[\"Middleground\"], mgToRender, minLengthRequirement, height, optLength, true);\n      this.genRoad(_ground__WEBPACK_IMPORTED_MODULE_1__[\"Foreground\"], fgToRender, minLengthRequirement, height, optLength, false);\n    }\n  }, {\n    key: \"genRoad\",\n    value: function genRoad(GroundClass, lengthsObj, minLengthRequirement, height) {\n      var optLength = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;\n      var povToggle = arguments.length > 5 ? arguments[5] : undefined;\n\n      for (var x = 0; x < _game__WEBPACK_IMPORTED_MODULE_0__[\"default\"].X_DIMS; x += minLengthRequirement) {\n        if (lengthsObj[x]) {\n          _game__WEBPACK_IMPORTED_MODULE_0__[\"default\"].PeicesToDraw.push(new GroundClass(x, 10, 0, minLengthRequirement, optLength, height, povToggle));\n        }\n      }\n    }\n  }, {\n    key: \"generateLengthPojos\",\n    value: function generateLengthPojos(minLengthRequirement) {\n      var lengths = [[], [], []];\n\n      for (var i = 0; i < _game__WEBPACK_IMPORTED_MODULE_0__[\"default\"].X_DIMS;) {\n        var chosenPojo = Math.round(Math.random() * 2);\n\n        for (var j = 0; j < minLengthRequirement; j++) {\n          switch (chosenPojo) {\n            case 0:\n              lengths[0][i] = true;\n              lengths[1][i] = false;\n              lengths[2][i] = false;\n              break;\n\n            case 1:\n              lengths[0][i] = false;\n              lengths[1][i] = true;\n              lengths[2][i] = false;\n              break;\n\n            case 2:\n              lengths[0][i] = false;\n              lengths[1][i] = false;\n              lengths[2][i] = true;\n              break;\n          }\n\n          i++;\n        }\n      }\n\n      return lengths;\n    }\n  }, {\n    key: \"povChange\",\n    value: function povChange() {}\n  }]);\n\n  return Level;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Level);\n\n//# sourceURL=webpack:///./src/level.js?");
